...
function Aside() {
  ...
  const styles = `animated-bg px-4 fixed h-[100vh] md:left-0 ${showAside?`left-0 md:w-[300px]`:`left-[-100%]`} w-[300px] z-[11] top-0 duration-200 bg-white shadow-lg shadow-gray-400 md:shadow-none md:border-r-[1.5px] border-gray-200 md:w-[70px] flex flex-col justify-between`;
